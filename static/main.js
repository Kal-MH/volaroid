...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _scss_styles_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../scss/styles.scss */ \"./assets/scss/styles.scss\");\n/* harmony import */ var _scss_styles_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_scss_styles_scss__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _subFunctions_header__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./subFunctions/header */ \"./assets/js/subFunctions/header.js\");\n/* harmony import */ var _subFunctions_header__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_subFunctions_header__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _subFunctions_search__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./subFunctions/search */ \"./assets/js/subFunctions/search.js\");\n/* harmony import */ var _subFunctions_videoEdit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./subFunctions/videoEdit */ \"./assets/js/subFunctions/videoEdit.js\");\n/* harmony import */ var _subFunctions_changePassword__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./subFunctions/changePassword */ \"./assets/js/subFunctions/changePassword.js\");\n/* harmony import */ var _subFunctions_changePassword__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_subFunctions_changePassword__WEBPACK_IMPORTED_MODULE_4__);\n/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./api */ \"./assets/js/api.js\");\n\n\n\n\n\n\n\n//# sourceURL=webpack:///./assets/js/main.js?");

/***/ }),

/***/ "./assets/js/subFunctions/changePassword.js":
/*!**************************************************!*\
  !*** ./assets/js/subFunctions/changePassword.js ***!
  \**************************************************/
...
eval("var changePasswordForm = document.querySelector(\".changePassword-form\");\nvar changePasswordH3;\nvar changePasswordInputBox;\nvar HIDDEN = \"hidden\";\nvar h3Onset = 0;\n\nvar handleH3click = function handleH3click() {\n  if (h3Onset) {\n    changePasswordInputBox.classList.add(HIDDEN);\n    h3Onset = 0;\n  } else {\n    changePasswordInputBox.classList.remove(HIDDEN);\n    h3Onset = 1;\n  }\n};\n\nvar init = function init() {\n  changePasswordH3.addEventListener(\"click\", handleH3click);\n};\n\nif (changePasswordForm && changePasswordH3) {\n  changePasswordH3 = changePasswordForm.querySelector(\".changePassword-title\");\n  changePasswordInputBox = changePasswordForm.querySelector(\".changePassword__input-box\");\n  init();\n}\n\n//# sourceURL=webpack:///./assets/js/subFunctions/changePassword.js?");

/***/ }),

/***/ "./assets/js/subFunctions/header.js":
/*!******************************************!*\
  !*** ./assets/js/subFunctions/header.js ***!
  \******************************************/
/*! no static exports found */
...
eval("var body = document.querySelector(\"body\"); //searchModalWindow\n\nvar searchWindow = document.querySelector(\".search-container\");\nvar searchDiv = searchWindow.querySelector(\".search\");\nvar searchH1 = searchWindow.querySelector(\"h1\");\nvar searchInput = searchWindow.querySelector(\"input\"); //side-bar\n\nvar sideBar = document.querySelector(\".bar-container\");\nvar functions = sideBar.querySelectorAll(\"span\");\nvar menuIcon = functions[0].querySelector(\"i\");\nvar searchIcon = functions[1].querySelector(\"i\"); //window UPIcon\n\nvar upIcon = document.querySelector(\".window-up\");\nvar SHOW = \"show\";\nvar HIDDEN = \"hidden\";\nvar SLIDINGLOGGED = \"slidingLogged\";\nvar SLIDINGUNLOGGED = \"slidingUnlogged\";\nvar SLIDINGSEARCH = \"slidingSearch\";\nvar LOGGEDBAR = \"logged-bar\";\nvar UNLOGGEDBAR = \"unlogged-bar\";\nvar menuClickOnset = 0;\nvar searchClickOnset = 0;\n\nif (functions.length == 5) {\n  sideBar.classList.add(LOGGEDBAR);\n} else {\n  sideBar.classList.add(UNLOGGEDBAR);\n} //When you click loginspan in the header or login in the sidebar shows.\n\n\nvar handleSearchClick = function handleSearchClick() {\n  if (searchClickOnset) {\n    searchWindow.classList.remove(SLIDINGSEARCH);\n    searchClickOnset = 0;\n  } else {\n    searchWindow.classList.add(SLIDINGSEARCH);\n    searchClickOnset = 1;\n  }\n};\n\nvar handleBody = function handleBody(e) {\n  if (e.target != searchIcon && e.target != searchWindow && e.target != searchDiv && e.target != searchH1 && e.target != searchInput) {\n    if (searchClickOnset) handleSearchClick();\n  }\n};\n\nvar handleUpClick = function handleUpClick() {\n  window.scrollTo({\n    top: 0,\n    left: 0,\n    behavior: \"smooth\"\n  });\n}; //When you click the menu icon, sideBar shows.\n\n\nvar handleMenuClickSliding = function handleMenuClickSliding() {\n  if (menuClickOnset) {\n    if (functions.length == 5) {\n      sideBar.classList.remove(SLIDINGLOGGED);\n    } else {\n      sideBar.classList.remove(SLIDINGUNLOGGED);\n    }\n\n    menuClickOnset = 0;\n  } else {\n    if (functions.length == 5) {\n      sideBar.classList.add(SLIDINGLOGGED);\n    } else {\n      sideBar.classList.add(SLIDINGUNLOGGED);\n    }\n\n    menuClickOnset = 1;\n  }\n}; //When you scroll down, sideBar shows.\n\n\nvar scrollHeader = function scrollHeader() {\n  if (scrollY == 0) {\n    sideBar.classList.add(HIDDEN);\n  } else {\n    sideBar.classList.remove(HIDDEN);\n  }\n};\n\nvar init = function init() {\n  //window.onscroll = scrollHeader;\n  menuIcon.addEventListener(\"click\", handleMenuClickSliding);\n  upIcon.addEventListener(\"click\", handleUpClick);\n  searchIcon.addEventListener(\"click\", handleSearchClick);\n  body.addEventListener(\"click\", handleBody);\n};\n\nif (sideBar) {\n  init();\n}\n\n//# sourceURL=webpack:///./assets/js/subFunctions/header.js?");

/***/ }),

/***/ "./assets/js/subFunctions/search.js":
/*!******************************************!*\
  !*** ./assets/js/subFunctions/search.js ***!
  \******************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _searchKeywords__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./searchKeywords */ \"./assets/js/subFunctions/searchKeywords.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\nvar body = document.querySelector(\"body\"); //searchModalWindow\n\nvar searchWindow = document.querySelector(\".search-container\");\nvar searchForm = searchWindow.querySelector(\"form\");\nvar input = searchForm.querySelector(\"input\");\n\nvar sleep = function sleep(ms) {\n  return new Promise(function (resolve) {\n    return setTimeout(resolve, ms);\n  });\n};\n\nvar isInputFocused = function isInputFocused() {\n  return input === document.activeElement;\n};\n\nvar updatePlaceHolder = /*#__PURE__*/function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n    var now, term, i, _term, _i;\n\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            if (isInputFocused()) {\n              _context.next = 27;\n              break;\n            }\n\n            if (!(input.placeholder == \"\")) {\n              _context.next = 16;\n              break;\n            }\n\n            now = new Date();\n            term = _searchKeywords__WEBPACK_IMPORTED_MODULE_0__[\"keywords\"][now.getSeconds() % _searchKeywords__WEBPACK_IMPORTED_MODULE_0__[\"keywords\"].length];\n            i = 0;\n\n          case 5:\n            if (!(i < term.length)) {\n              _context.next = 14;\n              break;\n            }\n\n            if (!isInputFocused()) {\n              _context.next = 8;\n              break;\n            }\n\n            return _context.abrupt(\"break\", 14);\n\n          case 8:\n            input.placeholder += term[i];\n            _context.next = 11;\n            return sleep(100);\n\n          case 11:\n            i++;\n            _context.next = 5;\n            break;\n\n          case 14:\n            _context.next = 27;\n            break;\n\n          case 16:\n            _term = input.placeholder;\n            _i = 0;\n\n          case 18:\n            if (!(_i < _term.length)) {\n              _context.next = 27;\n              break;\n            }\n\n            if (!isInputFocused()) {\n              _context.next = 21;\n              break;\n            }\n\n            return _context.abrupt(\"break\", 27);\n\n          case 21:\n            input.placeholder = _term.slice(0, _term.length - (_i + 1));\n            _context.next = 24;\n            return sleep(50);\n\n          case 24:\n            _i++;\n            _context.next = 18;\n            break;\n\n          case 27:\n            setTimeout(updatePlaceHolder, 1000);\n\n          case 28:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n\n  return function updatePlaceHolder() {\n    return _ref.apply(this, arguments);\n  };\n}();\n\nvar init = function init() {\n  input.addEventListener(\"focus\", function () {\n    input.placeholder = \"\";\n  });\n  setTimeout(updatePlaceHolder, 1000);\n};\n\nif (searchWindow) {\n  init();\n}\n\n//# sourceURL=webpack:///./assets/js/subFunctions/search.js?");

/***/ }),

/***/ "./assets/js/subFunctions/searchKeywords.js":
/*!**************************************************!*\
  !*** ./assets/js/subFunctions/searchKeywords.js ***!
  \**************************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"keywords\", function() { return keywords; });\nvar keywords = [\"Awesome\", \"Coldplay\", \"JavaScript\", \"Wetube\", \"Love\"];\n\n//# sourceURL=webpack:///./assets/js/subFunctions/searchKeywords.js?");

/***/ }),

/***/ "./assets/js/subFunctions/videoEdit.js":
/*!*********************************************!*\
  !*** ./assets/js/subFunctions/videoEdit.js ***!
  \*********************************************/
/*! no exports provided */
...
eval("__webpack_require__(/*! @babel/polyfill */\"./node_modules/@babel/polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! D:\\Pro_Design\\JS\\git\\volaroid\\assets\\js\\main */\"./assets/js/main.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_./assets/js/main?");
